...
import { toHyphenTagName } from './internal/toHyphenTagName.js'
 ...
 * @type {<T extends object>(value: T, internals?: {}, name?: string) => T}
 */
...
export const Window = REGISTER(globalThis.Window || class Window extends EventTarget {
	...
	requestAnimationFrame(/** @type {(...args: any[]) => any} */ callback) {
		return setTimeout(callback, 1000 / 60)
	}

	requestIdleCallback(/** @type {(...args: any[]) => any} */ callback) {
		void callback
...
export const CustomElementRegistry = REGISTER(globalThis.CustomElementRegistry || class CustomElementRegistry {
	...
	define(/** @type {string} */ name, /** @type {typeof HTMLElement} */ constructor, /** @type {any} */ options) {
		void options
	...
	for(/** @type {typeof HTMLElement} */ constructor) {
		/** @type {ElementRegistryInternals} */
		const internals = INTERNALS_FOR(this)
...
const toAstroWebComponent = async (/** @type {{ [key: string]: () => Promise<{ default: typeof HTMLElement }> }} */ imports, importMetaUrl) => {
